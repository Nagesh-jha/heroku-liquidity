(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardComponent = /** @class */ (function () {
                function DashboardComponent(dialog, config) {
                    var _this = this;
                    this.dialog = dialog;
                    this.config = config;
                    this.user_list = [];
                    //get user list
                    this.config.getUser().then(function (data) {
                    });
                    //configure user list observable
                    this.config.user_list$.subscribe(function (data) {
                        _this.user_list = data;
                        console.log("list", data);
                    });
                    this.config.updateInUser$.subscribe(function (data) {
                        _this.config.getUser().then(function (data) { });
                    });
                }
                DashboardComponent.prototype.ngOnInit = function () {
                };
                DashboardComponent.prototype.addUser = function () {
                    var dialogRef = this.dialog.open(_modal_add_add_component__WEBPACK_IMPORTED_MODULE_3__["AddComponent"], {
                        width: '650px',
                        data: { type: 'add', data: '' }
                    });
                ...
                DashboardComponent.prototype.editUser = function (data) {
                    var dialogRef = this.dialog.open(_modal_add_add_component__WEBPACK_IMPORTED_MODULE_3__["AddComponent"], {
                        width: '650px',
                ...
                DashboardComponent.prototype.deleteUser = function (data) {
                    // let req = { _id: id }
                    var dialogRef = this.dialog.open(_modal_add_add_component__WEBPACK_IMPORTED_MODULE_3__["AddComponent"], {
                        width: '450px',
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(router, config) {
                    this.router = router;
                    this.config = config;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddComponent = /** @class */ (function () {
                function AddComponent(config, dialog, dialogRef, data) {
                    var _this = this;
                    this.config = config;
                    this.dialog = dialog;
                    ...
                    this.config.departmentList$.subscribe(function (list) {
                        _this.departmentList = list;
                        console.log("depart", list);
                    });
                    this.config.updateInDepart$.subscribe(function (list) {
                        _this.config.getDepartment().then();
                    });
                }
                ...
                AddComponent.prototype.modalClose = function () {
                    this.dialogRef.close();
                };
                AddComponent.prototype.selectedDepart = function (depart) {
                    // alert(depart)
                };
                AddComponent.prototype.saveDepartment = function () {
                    var req = { department: this.newDepartment };
                    this.config.saveDepartment(req).then();
                    this.user_data.department = '';
                    this.newDepartment = '';
                };
                AddComponent.prototype.cancleDepart = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ConfigService = /** @class */ (function () {
                function ConfigService(http, toastr, router) {
                    this.http = http;
                    this.toastr = toastr;
                    this.router = router;
                ...
                ConfigService.prototype.canActivate = function () {
                ...
                ConfigService.prototype.login = function (request) {
                    var _this = this;
                    return this.http
                ...
                ConfigService.prototype.getUser = function () {
                    ...
                    return this.http
                        ...
                        .then(function (response) {
                        if (response.success == 0) {
                            _this.user_list$.next(response.data);
                        }
                    })
                        .catch(this.handleError('user list'));
                };
                ConfigService.prototype.createUser = function (data) {
                    var _this = this;
                    return this.http
                        ...
                        .then(function (response) {
                        if (response.success == 0) {
                            _this.updateInUser$.next('update');
                ...
                ConfigService.prototype.updateUser = function (request) {
                    var _this = this;
                    return this.http
                ...
                ConfigService.prototype.deleteUser = function (id) {
                    var _this = this;
                    var httpOption = {
                ...
                ConfigService.prototype.getDepartment = function () {
                    var _this = this;
                    return this.http
                        ...
                        .then(function (response) {
                        if (response.success == 0) {
                            _this.departmentList$.next(response.data);
                        }
                    })
                        .catch(this.handleError('department list'));
                };
                ConfigService.prototype.saveDepartment = function (req) {
                    var _this = this;
                    return this.http
                        ...
                        .then(function (response) {
                        if (response.success == 0) {
                            _this.updateInDepart$.next('update');
                            _this.toastr.success(response.message);
                        }
                        else {
                            _this.toastr.error(response.message);
